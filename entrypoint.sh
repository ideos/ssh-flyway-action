...
flyway -locations="filesystem:./$INPUT_MIGRATIONS_PATH" -driver=$FLYWAY_DRIVER -url="$FLYWAY_URL_PREFIX://localhost:3265/$INPUT_DB_NAME" -user=$INPUT_DB_USER -password=$INPUT_DB_PASSWORD migrate
